 ...
 */
final class Version20190805012102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('insert into ignore user set email="user@test.com",roles="ROLE_USER",password="$2y$13$W4fNVg6gw5y3FPZnhsAhKOQ4A4KO6S1vMxJlu7tSNZOVVIs2CGtzG";);
    }
